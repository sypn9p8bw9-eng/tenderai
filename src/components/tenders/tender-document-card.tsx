...
export function TenderDocumentCard({ document, organizationSlug, tenderId }: TenderDocumentCardProps) {
  return (
    <article className="flex flex-col gap-4 rounded-xl border bg-card p-4 shadow-sm sm:flex-row sm:items-center sm:justify-between">
